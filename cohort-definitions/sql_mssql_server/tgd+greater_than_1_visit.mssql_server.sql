...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (8870,9203,262,38004515,8717,9201,8756,9202)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (8870,9203,262,38004515,8717,9201,8756,9202)
  and c.invalid_reason is null
